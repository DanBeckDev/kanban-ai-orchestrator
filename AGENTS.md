...
2. Inspect every changed source file for vertical density and responsibility boundaries. The source-structure gate limits every production and test file to 400 meaningful lines, with no exceptions; split distinct responsibilities before the quality review rather than treating a large file as presumptively cohesive. Record each source file's exact meaningful-line count, cohesive responsibility, and review decision in the quality-review receipt; the receipt gate verifies this inventory.
